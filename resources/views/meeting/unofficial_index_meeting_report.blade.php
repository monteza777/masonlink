...
<h2 class="alert-warning">UNOFFICIAL MEETING REPORTS</h2>
...
<li>
<a href="{{ route('meetingControllerUoCreate') }}" class="btn btn-primary btn btn-sm">
...
<ul class="list-unstyled list-inline">
	...
	<li> <a class="btn btn-primary btn btn-sm" href="{{'/meeting/'.$reportsList->id.'/edit'}}">
  	...
  	<li>
       {{Form::open(['action'=> ['meetingController@deleteUo',$reportsList->id]])}}
